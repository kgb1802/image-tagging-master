...
with open(outfile_path, mode='w', newline='') as result_file:
    ...
    for img_path in results:
        ...
        if hasattr(predict_list_5000, 'tolist'):
            predict_list_5000 = predict_list_5000.tolist()
        if isinstance(predict_list_5000, list) and len(predict_list_5000) == 1 and isinstance(predict_list_5000[0], (list, tuple)):
            predict_list_5000 = list(predict_list_5000[0])
